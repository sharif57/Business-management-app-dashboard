...
const Sidebar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-[290px] min-h-screen h-full pr-0 bg-[#1B2A2F] text-[#B8BDBF]">
                      ...
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          isActive
                            ...
                            " w-full px-4 py-3 flex items-center justify-start gap-3 text-md transition-all rounded-lg"
